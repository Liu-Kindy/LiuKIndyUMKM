...
<head>
    ...
    <title>Freddy's Pizzaria - UMKM Pizza Keluarga</title>
    <!-- Bootstrap 5 CSS -->
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #8B3A3A;">
    <div class="container">
        <a class="navbar-brand fw-bold fs-2" href="index.php">
            <i class="fas fa-pizza-slice"></i> Freddy's Pizzaria
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="detail.php">Menu Detail</a></li>
